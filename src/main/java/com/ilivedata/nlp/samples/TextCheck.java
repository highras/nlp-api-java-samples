...
public class TextCheck {
    ...
    private String endpointHost = "tsafe.ilivedata.com";
    private String endpointPath = "/api/v1/text/check";
    private String endpointURL = "https://tsafe.ilivedata.com/api/v1/text/check";

    public String check(String text, String userId) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String result = textCheck.check(text, "12345678");
