...
public class ImageCheck {
    ...
    private String endpointHost = "isafe.ilivedata.com";
    private String endpointPath = "/api/v1/image/check";
    private String endpointURL = "https://isafe.ilivedata.com/api/v1/image/check";

    public String check(String image, int type, String userId) throws IOException {
