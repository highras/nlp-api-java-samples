...
public class SpeechRecognize {
    ...
    public String recognize(String audio, String languageCode, String userId) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String result = speech.recognize(audio, "zh-CN", "12345678");
        System.out.println(result);
        result = speech.recognize(audio, "zh-CN", "12345678");
        System.out.println(result);
    }
