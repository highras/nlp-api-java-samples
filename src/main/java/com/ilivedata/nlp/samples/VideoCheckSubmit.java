...
public class VideoCheckSubmit {
    ...
    private String endpointPath = "/api/v1/video/check/submit";
    private String endpointURL = "https://vsafe.ilivedata.com/api/v1/video/check/submit";

    public String check(String videoUrl, int type, String userId) throws IOException {
        String now = ZonedDateTime.now(ZoneId.of("UTC")).format(FORMATTER);
        
        Map<String, Object> parameters = new HashMap<String, Object>();
        parameters.put("type", type);
        parameters.put("video", videoUrl);
    ...
    public static void main(String[] args) throws IOException {
        String videoUrl = "http://edge.ivideo.sina.com.cn/34463529803.mp4?KID=sina,viask&Expires=1597852800&ssig=6po29lqbTn&reqid=";
        VideoCheckSubmit videoCheckSubmit = new VideoCheckSubmit();
        String result = videoCheckSubmit.check(videoUrl, 1, "12345678");
