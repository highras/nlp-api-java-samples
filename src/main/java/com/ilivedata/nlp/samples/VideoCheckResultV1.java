...
public class VideoCheckResultV1 {
    ...
    private String endpointPath = "/api/v1/video/check/result";
    private String endpointURL = "https://vsafe.ilivedata.com/api/v1/video/check/result";

    private static Gson gson = new Gson();

    public VideoCheckResultDto result(String taskId) throws IOException {
        ...
        return gson.fromJson(result, VideoCheckResultDto.class);
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        VideoCheckResultV1 videoCheckResult = new VideoCheckResultV1();
        VideoCheckResultDto result = videoCheckResult.result(taskId);
        System.out.println(result);
    }

}

class VideoCheckResultDto {
    private Integer errorCode;
    private Integer code;
    private Integer result;
    private String taskId;
    private List<VideoSpam> videoSpams;
}
