...
public class TranslateV3 {
    ...
    private String endpointPath = "/api/v3/translate";
    private String endpointURL = "https://translate.ilivedata.com/api/v3/translate";

    public String translate(String target, String sentence) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        TranslateV3 translateV3 = new TranslateV3();
        String result = translateV3.translate("zh-CN", "Hello World!");
