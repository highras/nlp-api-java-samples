...
public class LiveVideoCheckSubmit {
    ...
    private String endpointPath = "/api/v1/livevideo/check/submit";
    private String endpointURL = "https://vsafe.ilivedata.com/api/v1/livevideo/check/submit";
    ...
    public static void main(String[] args) throws IOException {
        String videoUrl = "LIVE_AUDIO_URL";
        LiveVideoCheckSubmit videoCheckSubmit = new LiveVideoCheckSubmit();
