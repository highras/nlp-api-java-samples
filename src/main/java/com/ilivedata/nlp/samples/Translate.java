...
public class Translate {
    ...
    private String endpointPath = "/api/v2/translate";
    private String endpointURL = "https://translate.ilivedata.com/api/v2/translate";

    public String translate(String source, String target, String sentence) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String result = translate.translate("en", "zh-CN", "Hello World!");
