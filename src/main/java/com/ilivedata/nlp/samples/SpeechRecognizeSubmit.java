...
public class SpeechRecognizeSubmit {
    ...
    private String endpointPath = "/api/v1/speech/recognize/submit";
    private String endpointURL = "https://asr.ilivedata.com/api/v1/speech/recognize/submit";

    public String recognize(String audioUrl, String languageCode, String userId, boolean speakerDiarization) throws IOException {
        ...
        // Optional parameter config
        Map<String, Object> diarizationConfig = new HashMap<String, Object>();
        config.put("enableSpeakerDiarization", speakerDiarization);

        Map<String, Object> parameters = new HashMap<String, Object>();
        parameters.put("languageCode", languageCode);
        parameters.put("diarizationConfig", diarizationConfig);
        parameters.put("config", config);
        parameters.put("uri", audioUrl);
    ...
    public static void main(String[] args) throws IOException {
        ...
        SpeechRecognizeSubmit speech = new SpeechRecognizeSubmit();
        String result = speech.recognize(audioUrl, "zh-CN", "12345678", true);
