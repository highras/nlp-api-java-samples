...
public class AudioCheckSubmit {
    ...
    private String endpointPath = "/api/v1/audio/check/submit";
    private String endpointURL = "https://asafe.ilivedata.com/api/v1/audio/check/submit";
    ...
    public static void main(String[] args) throws IOException {
        ...
        AudioCheckSubmit audioCheckSubmit = new AudioCheckSubmit();
