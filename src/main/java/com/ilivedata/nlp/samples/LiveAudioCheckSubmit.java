...
public class LiveAudioCheckSubmit {
    ...
    private String endpointPath = "/api/v1/liveaudio/check/submit";
    private String endpointURL = "https://asafe.ilivedata.com/api/v1/liveaudio/check/submit";

    public String check(String audioUrl, int type, String lang, String userId) throws IOException {
        String now = ZonedDateTime.now(ZoneId.of("UTC")).format(FORMATTER);
        
        Map<String, Object> parameters = new HashMap<String, Object>();
        parameters.put("type", type);
        parameters.put("lang", lang);
        parameters.put("audio", audioUrl);
    ...
    public static void main(String[] args) throws IOException {
        String audioUrl = "LIVE_AUDIO_URL";
        LiveAudioCheckSubmit audioCheckSubmit = new LiveAudioCheckSubmit();
        String result = audioCheckSubmit.check(audioUrl, 1, "zh-CN", "12345678");
