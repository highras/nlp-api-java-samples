...
public class LiveVideoCheckResult {
    ...
    private String endpointPath = "/api/v1/livevideo/check/result";
    private String endpointURL = "https://vsafe.ilivedata.com/api/v1/livevideo/check/result";
    ...
    public static void main(String[] args) throws IOException {
        ...
        LiveVideoCheckResult videoCheckResult = new LiveVideoCheckResult();
        String result = videoCheckResult.result(taskId);
